  ...
  return (
    <div className='flex  '>
        ...
        <div className='flex flex-col  text-xs '>
          <p className='text-[0.6rem] pl-2 mb-1'>Status</p>
          ...
          <div className='flex flex-col  text-xs  '>
          <p className='text-[0.6rem] pl-2 mb-1'>Order ID</p>
          ...
          <div className='flex flex-col  text-xs  '>
          <p className='text-[0.6rem] pl-2 mb-1'>Service</p>
           <p className='bg-ternary-light p-6 text-center border-y border-r border-primary-dark flex h-[6rem] items-center w-[8rem] justify-center'>{serviceandOcassion}</p>
        </div>

          <div className='flex flex-col text-xs  '>
          <p className='text-[0.6rem] pl-2 mb-1'>Address</p>
          ...
          <div className='flex flex-col text-xs  '>
          <p className='text-[0.6rem] pl-2 mb-1'>Date and time</p>
           <p className='bg-ternary-light p-4 text-center border-y  border-primary-dark flex h-[6rem] items-center w-[8rem] justify-center'>{dateAndTime}</p>
        </div>

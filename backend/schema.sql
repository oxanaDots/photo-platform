...
insert into services (service_id, hourly_rate, day_rate) values ('photo_service', 100, 500),
('video_service', 200, 800),
('photo_and_video', 500, 1200);

insert into locations(street_name, street_number, postcode) values ('Southlands road', 36, 'BR2 9QP');